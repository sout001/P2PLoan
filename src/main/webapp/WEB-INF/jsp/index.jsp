    ...
    <nav class="navbar navbar-inverse navbar-static-top site-nav " role="navigation"> 
     <div class="container new-home-container"> 
      ...
      <ul id="nonLoginBar" class="nav navbar-nav navbar-right navbar-sm site-nav-login"> 
       <li><a id="login-panel" href="<% request.getContextPath(); %>/login" rel="nofollow">登录</a></li>
       <li><a id="create-account" href="<% request.getContextPath(); %>/reg" class="btn btn-sm" rel="nofollow">注册账户</a></li>
      </ul> 
      <ul class="nav navbar-nav navbar-right navbar-sm site-nav-user"> 
       <li class="dropdown"> <a href="<% request.getContextPath(); %>/userA" class="dropdown-toggle hoverHeader"  data-toggle="dropdown" data-hover="dropdown">${user.username} <b class="caret"></b></a>
        <ul class="dropdown-menu"> 
         <li><a href="<% request.getContextPath(); %>/userA">我的账户</a></li>
         <li><a href="<% request.getContextPath(); %>/login">退出</a></li>
        </ul> </li> 
      </ul> 
     </div> 
    </nav> 
       ...
       <div class="container"> 
        ...
        <div class="sl-nav col-xs-10"> 
         <ul class="nav navbar-nav main-menu"> 
          <!--menus--> market
          <li class="main-link-list"> <a class="main-link" href="<% request.getContextPath(); %>/borrow"> <span class="sl-icon-bold-money-bag"></span> <span class="main-link-text">我要借款</span> </a> </li>
          <li class="main-link-list"> <a class="main-link" href="<% request.getContextPath(); %>/market"> <span class="sl-icon-bold-trend"></span> <span class="main-link-text">我要投资</span> </a> </li>
     ...
     <div class="row login-register-row"> 
      ...
      <div class="col-xs-4 register-tab login-shown"> 
       ...
       <div class="login-content text-center"> 
        ...
        <div class="number-cash">${account.usableAmount}</div>
        <div> 
         <a class="btn btn-primary recharge" href="<% request.getContextPath(); %>/pay">充值</a>
        </div> 
        <div> 
         <a class="btn btn-primary account-info" href="<% request.getContextPath(); %>/userA">我的账户</a>
        </div> 
       </div> 
      </div> 
